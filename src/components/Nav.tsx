    ...
    >
      <Navbar.Brand href="/">
        <span className={`self-center whitespace-nowrap font-bold dark:text-white transition-all duration-300 ${
          ...
          <span className="text-green-500">&gt;_</span> Daryl Gatt
        </span>
      </Navbar.Brand>
      
      {/* Second container: GitHub Button + Contact Me */}
      <div className="flex md:order-2">
        <a
          href="https://github.com/phantom0004"
          target="_blank"
          rel="noopener noreferrer"
          className={`hidden md:flex mx-3 bg-black hover:bg-gray-900 py-2 px-4 transition-all duration-300 flex items-center gap-2 ${
        ...
        >
          ...
          <span className="text-white font-medium">Visit My GitHub Portfolio</span>
        </a>
